...
function addParrafo()
           ...
           {
			let parrafodelete = event.target;   
			let divRespuesta = <HTMLElement>document.getElementById("respuesta"); 
           ...
           function lanzar()
           {
              ...
              let boton = <HTMLInputElement> document.createElement("input");
            ...
            window.onload = function() {
                ...
                miFormulario=<HTMLFormElement>document.getElementsByName("miFormulario")[0];
				miFormulario.titulo.onblur=validar;
				miFormulario.numero.onblur=validar;
